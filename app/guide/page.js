          ...
          <section className="content py-8">
            <div className="container mx-auto flex flex-col items-center">
              <ol className="prose prose-lg text-center">
                ...
                <li>
                  Step 3: Click the lock emoji to lock the teams and start the game.
                </li>
                <li>
                  Step 4: At the end of the game, answer the generated message in the text channel to inform the bot which team won.
                </li>
                <li>
                  Step 5: Thus, your league is created! Click the trophy emoji to see the league statistics and rankings.
                </li>
              </ol>
            </div>
          </section>
    ...
    <div>
      ...
      <section className="hero py-16 text-center">
          ...
          <button 
            ...
            className={`bg-accent hover:bg-accent-light text-white font-bold py-2 px-4 rounded mr-4 ${guideType === 'individual' ? 'shadow-glow' : ''}`}
          >
            Guide for Individual Stats
          </button>
          <button 
            onClick={() => handleClick('team')}
            className={`bg-accent hover:bg-accent-light text-white font-bold py-2 px-4 rounded ${guideType === 'team' ? 'border-2 border-blue-500' : ''}`}
          >
